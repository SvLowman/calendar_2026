...
const parcours01 = {
    accordion: {
      1: {
        ...
        "panel-info": "LISSABON ist die Hauptstadt von Portugal - und mit 550.000 Einwohnern auch die größte Stadt des Landes. 1755 wurde die Stadt durch ein Erdbeben fast vollständig zerstört und danach neu aufgebaut.",
        "panel-image": "./assets/08 - 0101.JPG",
      },
      2: {
        "button-p": "Und vor allem: Warum?",
        "panel-info": "Pedro IV. war ein portugiesischer König (die Statue oben auf der Säule stellt ihn dar). Weil er Portugal im 19. Jahrhundert moderner gemacht hat, wurde ihm dieses Denkmal aufgestellt.",
      },
    },
  };
  ...
  const parcours03 = {
    memory: {
      pair1: {
        cards: [
        { type: "text", value: "Handelsplatz" },
        { type: "image", value: "./assets/08 - 0301.JPG" },
      ],
        feedback: "Früher stand hier der Königspalast, der beim Erdbeben 1755 zerstört wurde. Danach entstand hier der bedeutendste Platz der Stadt.",
        color: "var(--accent-1)",
      },
      pair2: {
        cards: [
        { type: "text", value: "Turm von Belém" },
        { type: "image", value: "./assets/08 - 0302.JPG" },
      ],
        feedback: "Vor 500 Jahren wurde der Turm gebaut, um den Hafen von Lissabon zu bewachen. Die Verzierungen sollten zugleich den Reichtum Portugals zeigen.",
        color: "var(--accent-2)",
      },
      pair3: {
        cards: [
        { type: "text", value: "Denkmal der Entdecker" },
        { type: "image", value: "./assets/08 - 0303.JPG" },
      ],
        feedback: "Vor 500 Jahren schickte Portugal viele Seefahrer über die Weltmeere. Das Monument erinnert an diese Seefahrten, die oft von Lissabon ausgingen.",
        color: "var(--accent-3)",
      }
    },
  };
  ...
  const parcours04 = {
    "single-choice": {
      card1: {
        question: "Wie heißt das schwarzweiße Muster auf dem Boden des Rossio?",
        options: ["Offenes Meer", "Zebraschleifen", "Monochrausen"],
        answer: "Der Name 'Mar Largo' bedeutet 'Offenes Meer'. Das Wellenmotiv gehört zur portugiesischen Pflasterkunst, der Calçada Portuguesa.",
      },
      card2: {
        question: "Welchen zweiten Titel trug Pedro IV.?",
        options: ["Kaiser von Brasilien", "Zar von Korea", "Fürst von Texas"],
        answer: "1826 erbte Pedro von seinem Vater die brasilianische Krone. Weil es ihm zu anstregend war, zwei Länder gleichzeitig zu beherrschen, gab er kurz darauf die portugiesische Königswürde an seine Tochter Maria ab.",
      },
    },
  };
