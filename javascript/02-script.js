...
const parcours01 = {
    accordion: {
      ...
      2: {
        ...
        "panel-info": "Der Besitzer der Brauerei Carlsberg liebte Skulpturen. Im Jahre 1913 war er nach einer Ballettaufführung des Märchens von der Kleinen Meerjungfrau so begeistert, dass er eine Skulptur der Figur am Hafen aufstellen ließ.",
      },
    },
  };
  ...
  const parcours03 = {
    memory: {
      pair1: {
        cards: [
        { type: "text", value: "Eriksen" },
        { type: "image", value: "./assets/02 - 0301.JPG" },
      ],
        feedback: "Der Bildhauer Edvard Eriksen modellierte die Kleine Meerjungfrau nach der Märchenfigur von Hans Christian Andersen.",
        color: "var(--accent-1)",
      },
      pair2: {
        cards: [
        { type: "text", value: "P. T. Barnum" },
        { type: "image", value: "./assets/02 - 0302.JPG" },
      ],
        feedback: "Der amerikanische Schausteller P. T. Barnum stellte 1840 eine angeblich echte Meerjungfrau aus. Se bestand aus einer Affenmumie, an die ein Fischschwanz genäht war.",
        color: "var(--accent-2)",
      },
      pair3: {
        cards: [
        { type: "text", value: "Disney" },
        { type: "image", value: "./assets/02 - 0303.JPG" },
      ],
        feedback: "Die Disney-Studios produzierten die bekannteste Verfilmung von Andersens Märchen.",
        color: "var(--accent-3)",
      }
    },
  };
  ...
  const parcours04 = {
    "single-choice": {
      card1: {
        question: "Wodurch gelangte die Kleine Meerjungfrau zu Weltruhm?",
        options: ["Sie wurde beschädigt", "Sie wurde UNESCO-Weltkulturerbe", "Sie erhielt einen Architekturpreis"],
        answer: "1964 wurde der Kleinen Meerjungfrau von Unbekannten der Kopf abgesägt. Die Statue wurde dadurch weltberühmt.",
      },
      card2: {
        question: "Wie groß ist die Statue der Kleinen Meerjungfrau?",
        options: ["1,25 Meter", "2,50 Meter", "9,70 Meter"],
        answer: "Die Kleine Meerjungfrau ist eine der kleinsten internationalen Sehenswürdigkeiten. Sie war nicht als Denkmal geplant, sondern als zugängliches Kunstobjekt am Hafen.",
      },
    },
  };
